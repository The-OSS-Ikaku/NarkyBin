...
/datum/game_mode/nuclear
	...
	config_tag = "nuclear"
	required_players = 6 // 20 players - 5 players to be the nuke ops = 15 players remaining
	required_enemies = 1 //Narky changing to 1
...
/datum/game_mode/nuclear/pre_setup()
	...
	/*if(agent_number > n_players)
		agent_number = n_players/6*/
	agent_number=min(agent_number,n_players/5)
