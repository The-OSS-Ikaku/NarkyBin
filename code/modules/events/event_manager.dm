...
/datum/controller/event/proc/reschedule()
	...
	if(world.time >= 36000 && world.time < 72000) //More than an hour has passed
		...
		captain_announce("The emergency shuttle has been called due to the station's abnormal status. It will arrive in [round(emergency_shuttle.timeleft()/60)] minutes.")
