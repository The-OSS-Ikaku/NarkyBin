/mob/living/carbon/human/examine()
	...
	//body
	var/disp_race=dna&&dna.mutantrace ? dna.mutantrace : "human"
	if( !skipjumpsuit && !skipface )
		msg += "[t_He] [t_is] a [disp_race][disp_race=="human"&&dna&&dna.mutanttail ? " with a tail" : ""].\n"
	/*if(usr.show_gen)
		if( !skipjumpsuit && (!w_uniform||!(w_uniform.body_parts_covered&GROIN)) )
			if(dna&&dna.cock["has"])
				if(dna.cock["has"]==dna.COCK_NORMAL)
					msg += "They have a[dna.cock["type"]=="human" ? "" : " [dna.cock["type"]]"] cock.\n"
				else if(dna.cock["has"]==dna.COCK_HYPER)
					msg += "They have a massive[dna.cock["type"]=="human" ? "" : " [dna.cock["type"]]"] cock.\n"
				else if(dna.cock["has"]==dna.COCK_DOUBLE)
					msg += "They have two[dna.cock["type"]=="human" ? "" : " [dna.cock["type"]]"] members.\n"
			if(dna&&dna.vagina)
				msg += "They have a vagina.\n"*/
	...
	if( (vore_womb_datum.has_people()||vore_stomach_datum.has_people()) && !skipjumpsuit )
		msg += "It seems [t_his] belly is shifting around slighty.\n"
	if( (vore_breast_datum.has_people()||vore_breast_datum.digestion_count) && !skipjumpsuit )
